...
extension UIViewController {
    ...
    func showDefaultAlert() {
        ...
        UIApplication.shared.appDelegate.navigationController.showAlert(withStyle: .alert, title: nil, message: "Something went wrong", actions: okAction, completion: nil)
    }
}
